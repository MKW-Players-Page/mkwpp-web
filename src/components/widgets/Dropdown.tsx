...
const Dropdown = ({ children, disabled, valueSetter }: DropdownProp) => {
    ...
    children = children.map((child) =>
        cloneElement(child, { ...child.props, _selectedSetter: setSelectedItemData, _valueSetter: valueSetter, }),
    );
...
export const DropdownItem = ({ text, leftIcon, rightIcon, value, _selectedSetter, _valueSetter }: DropdownItemProp) => {
